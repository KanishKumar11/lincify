          ...
          >
            ...
            <motion.div variants={itemVariants} className=" text-white">
              <div class="lg:max-w-xl w-full h-[500px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://pagedone.io/asset/uploads/1696245837.png')] ">
                <div class="">
                  <div class="lg:w-96 w-auto h-auto bg-white/20 backdrop-blur-3xl rounded-xl shadow-xl lg:p-6 p-4">
                    <div className="mx-auto  my-7 w-max">
                      {" "}
                      <Logo />
                    </div>
                    <a href="tel:+919266866692" class="flex items-center mb-6">
                      <svg
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
